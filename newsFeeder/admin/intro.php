			...
			<h1><?php esc_attr_e( 'Welcome to NewsFeeder!', 'wp_admin_style' ); ?></h1>
				...
				<div class="welcome-panel-column-container">					
					<div class="welcome-panel-column">									
						...
						<p id="footer-left" class="alignleft"><?php esc_attr_e( 'Powered by https://newsapi.org/', 'wp_admin_style' ); ?></p>
						<br>
					</div>
					
					<div class="welcome-panel-column">
						<h3><?php esc_attr_e( 'Useful step', 'wp_admin_style' ); ?></h3>
						<?php $url_doc = 'http://webberaction.com/newsfeeder-plugin/documentation/'; ?>
						<ul>
...
<div id="terms_tab" class="tabcontent" style="display: none;">
	<div id="welcome-panel" class="welcome-panel">
		<div class="welcome-panel-content">
			...
			<p class="about-description"><?php esc_attr_e( '1. The web search system is powered by the search engine "www.faroo.com" and according to its terms of use, is based on peer-to-peer architecture, is not managed by any authority, does not guarantee the quality and availability of the service. This service is not administered and does not belong to the NewsFeeder plugin.', 'wp_admin_style' ); ?></p><br>
			<p class="about-description"><?php esc_attr_e( '2. The NewsFeeder plugin is not owned, is not responsible, has no partnership and is not affiliated with the API source "https://newsapi.org".', 'wp_admin_style' ); ?></p><br>
			<p class="about-description"><?php esc_attr_e( '3. The NewsFeeder plugin has no responsibility for the services provided by both external sources mentioned above, and is not responsible for the availability of the contents, nor type of content quality.', 'wp_admin_style' ); ?></p><br>
			<p class="about-description"><?php esc_attr_e( '4. The NewsFeeder plugin is not responsible for your use of the information provided, nor for possible cancellations of your API key, nor damages and / or financial losses, or of any other type that it may cause to you.', 'wp_admin_style' ); ?></p><br>
			...
			<p class="about-description"><?php esc_attr_e( '6. And finally, this plugin is free and does not charge any fee, the news made available through this plugin are not authored by this plugin and the copyright of the source is reserved. ', 'wp_admin_style' ); ?></p><br>
